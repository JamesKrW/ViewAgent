...
```bash
bash scripts/scannet/download_scannet_client_open3d.sh   # viewagent15k_scannet_open3d.tar.gz
bash scripts/mindcube/download_mindcube.sh               # viewagent_mindcube.tar.gz
```
