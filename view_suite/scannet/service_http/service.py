...
def run(
    ...
    Args:
        ...
        ssl_keyfile / ssl_certfile: serve HTTPS instead of HTTP. Some networks drop
            long-lived plaintext connections between distant hosts, which truncates
            large multi-image responses; serving over TLS avoids that. A self-signed
            pair works if the client skips verification.
