...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--ai2thor-root", type=Path, default=repo_root / "data/ai2thor")
    parser.add_argument(
        "--viewsuite-root", type=Path, default=repo_root / "data/viewsuite_15k"
    )
    parser.add_argument(
        "--habitat-gs-root", type=Path, default=repo_root / "data/habitat_gs"
    )
    parser.add_argument(
        "--output",
        type=Path,
