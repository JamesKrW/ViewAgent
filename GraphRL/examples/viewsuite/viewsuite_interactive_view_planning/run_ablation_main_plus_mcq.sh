#!/usr/bin/env bash
# =============================================================================
# Supervision-signal ablation (exp 01) — condition D: MAIN + view-difference MCQ
#   generators  = multi_turn_action_gen, view_difference_mcq   (main + mcq)
#   sft dataset = multi_turn_action_gen,view_difference_mcq
...
#
# Usage:
#   bash run_ablation_main_plus_mcq.sh
#   # small dev smoke (3 iters, 10 RL steps each, 1 SFT epoch):
#   bash run_ablation_main_plus_mcq.sh iterations=3 \
...
COND=main_plus_mcq
GENERATORS="multi_turn_action_gen,view_difference_mcq"
DATASET="multi_turn_action_gen,view_difference_mcq"
