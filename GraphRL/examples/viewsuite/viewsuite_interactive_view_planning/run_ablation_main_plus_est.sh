#!/usr/bin/env bash
# =============================================================================
# Supervision-signal ablation (exp 01) — condition C: MAIN + view-difference ESTIMATION
#   generators  = multi_turn_action_gen, view_difference   (main + est)
#   sft dataset = multi_turn_action_gen,view_difference
...
#
# Usage:
#   bash run_ablation_main_plus_est.sh
#   # small dev smoke (3 iters, 10 RL steps each, 1 SFT epoch):
#   bash run_ablation_main_plus_est.sh iterations=3 \
...
DATASET="multi_turn_action_gen,view_difference"
